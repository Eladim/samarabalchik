...
export const metadata = {
  title: "Relax Center | Samara",
  description:
    "Discover our Relax Center - sauna, steam bath, jacuzzi, and a wide variety of massages and therapies at Samara in Balchik.",
};
